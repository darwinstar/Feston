package com.appstu.sattafestival.getting_there;
...
public class Getting_there extends Fragment {
	...
	private class GetData extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			Cursor c = sql.query(Config.TABLE_POSTS, null, "category=?", new String[] { "Transport" }, null, null, null);
			if (c.moveToFirst()) {
				int i = 0;
