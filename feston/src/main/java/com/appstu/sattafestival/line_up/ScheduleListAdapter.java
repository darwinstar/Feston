...
public class ScheduleListAdapter extends BaseAdapter {
	...
	public ScheduleListAdapter(Context context, Artists[] artists) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.labelTitle.setText(artists[position].getTitle() + " / " + artists[position].getCompany());

		String start = Config.getDate(artists[position].getStarts(), "EE HH.mm");
		String end = Config.getDate(artists[position].getEnds(), "HH.mm");

		holder.labelCompany.setText(artists[position].getStageTitle() + " / " + start + "-" + end);
