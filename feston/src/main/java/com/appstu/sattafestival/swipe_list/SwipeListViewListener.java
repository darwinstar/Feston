...
public interface SwipeListViewListener {
     ...
     */
    void onMove(int position, float x, View backView);
     ...
     */
    void onStart(int position, int action, boolean right, View view);
     ...
     * @param position list item
     */
    void onClickFrontView(int position, AdapterView adapterView);
